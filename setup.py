...
# This is no longer needed and was causing warnings. It's handled by pyproject.toml now.
...
extensions = [
    Extension(
        "size_constrained_clustering.k_means_constrained.mincostflow_vectorized_",
        [
    ...
    Extension(
        "size_constrained_clustering.sklearn_import.cluster._k_means",
        [
    ...
    Extension(
        "size_constrained_clustering.sklearn_import.metrics.pairwise_fast",
        [
    ...
    Extension(
        "size_constrained_clustering.sklearn_import.utils.sparsefuncs_fast",
        [
...
setup(
    ...
    version=VERSION,
    # setup_requires is also deprecated and handled by pyproject.toml
